...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="tabs/subjects.php" title="Subjects"><i class="fa fa-book"></i></a></li>
            <li><a href="tabs/tests.php" title="Tests"><i class="fa fa-clipboard-list"></i></a></li>
    ...
    <div class="main">
        ...
        <div class="kpi-row">
            ...
            <div class="kpi-card" onclick="location.href='tabs/tests.php'" style="cursor:pointer;">
